...
Page({
  ...
  bindIsDefault(){
    ...
    if (address.is_default ){
      ...
      wx.setStorageSync('address_default',0);
    }
    this.setData({
      address: address
    });
  ...
  saveAddress(){
    ...
    if (wx.getStorageSync('address_default') != 1 && address.is_default == 0) { 
      // wx.removeStorageSync('refresh');
      util.showErrorToast('请设置默认地址');
      return false;
    }
    ...
    util.request(api.AddressSave, { 
      ...
      if (res.errno === 0) {
        wx.navigateTo({
          url: '/pages/ucenter/address/address?refresh=1',
        })
        // wx.navigateBack({
        //   url: '/pages/ucenter/address/address?refresh=1',
        // })
        ...
        // wx.redirectTo({
        //   url: '/pages/shopping/address/address'  //new add
        // })
      }
    });
